...
export const MarketChart = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const {
        data,
        error
      } = await supabase.functions.invoke('get-stock-price', {
        body: {
  ...
  return <div className="cyber-card h-[400px] w-full py-0 px-[13px] mx-0 my-0">
      <div className="flex justify-between items-center mb-4">
        ...
        <Select value={selectedStock} onValueChange={setSelectedStock}>
          ...
          <SelectContent>
            {availableStocks.map(stock => <SelectItem key={stock.symbol} value={stock.symbol}>
      ...
      <div className="h-[300px]">
        {isLoading ? <div className="flex items-center justify-center h-full">
            ...
            <LineChart data={stockData}>
              ...
              <XAxis dataKey="time" stroke="#8892b0" tick={{
            fill: '#8892b0'
          }} />
              <YAxis stroke="#8892b0" tick={{
            fill: '#8892b0'
          }} domain={['auto', 'auto']} />
            ...
            color: '#8892b0'
              ...
              <Line type="monotone" dataKey="value" stroke="#00f0ff" strokeWidth={2} dot={{
            fill: '#00f0ff'
